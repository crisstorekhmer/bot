        ...
        for update in updates["result"]:
            ...
            # ២. ករណីអតិថិជនផ្ញើសារអត្ថបទធម្មតា ឬចុចប៊ូតុង
                ...
                # ==========================================
                    ...
                    cpm_menu = {
                        "keyboard": [
                            ...
                            [{"text": "💵 500M Money - $1"}, {"text": "💵 1000M Money - $1.25"}],
                            [{"text": "🔓 Unlock All Cars - $1.35"}, {"text": "👑 VIP Package - $2"}],
                            [{"text": "🔙 ត្រឡប់ក្រោយ"}],
                        ],
                        "resize_keyboard": True,
                    }
                ...
                # --- ការផ្ទៀងផ្ទាត់កញ្ចប់ Car Parking ---
                    ...
                    "🪙 5,500 Coins - $0.25", "🪙 10,000 Coins - $0.35",
                    "🪙 20,000 Coins - $0.60", "🪙 30,000 Coins - $0.85",
                    "💵 500M Money - $1", "💵 1000M Money - $1.25",
                    "🔓 Unlock All Cars - $1.35", "👑 VIP Package - $2"
                ]:
