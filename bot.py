        ...
        for update in updates["result"]:
            ...
            # ២. ករណីអតិថិជនផ្ញើសារអត្ថបទធម្មតា ឬចុចប៊ូតុង
                ...
                # ==========================================
                    ...
                    ml_menu = {
                        "keyboard": [
                            [{"text": "💎 86 Diamonds - $1.35"}, {"text": "💎 172 Diamonds - $2.69"}],
                            [{"text": "💎 257 Diamonds - $3.69"}, {"text": "💎 344 Diamonds - $4.99"}],
                            [{"text": "💎 429 Diamonds - $6.79"}, {"text": "💎 514 Diamonds - $7.44"}],
                ...
                # --- ការផ្ទៀងផ្ទាត់កញ្ចប់ Free Fire (បានកែតម្លៃថ្មី) ---
                elif text in [
                ...
                # --- ការផ្ទៀងផ្ទាត់កញ្ចប់ Mobile Legends (បានកែតម្លៃថ្មី) ---
                elif text in [
                    "💎 86 Diamonds - $1.35", "💎 172 Diamonds - $2.69",
                    "💎 257 Diamonds - $3.69", "💎 344 Diamonds - $4.99",
                    "💎 429 Diamonds - $6.79", "💎 514 Diamonds - $7.44",
                ...
                # --- ការផ្ទៀងផ្ទាត់កញ្ចប់ Honor of Kings (បានកែតម្លៃថ្មី) ---
                elif text in [
                ...
                # --- ការផ្ទៀងផ្ទាត់កញ្ចប់ PUBG Mobile (បានកែតម្លៃថ្មី) ---
                elif text in [
                ...
                # ពេលអតិថិជនវាយបញ្ចូល User ID / Character ID
                else:
