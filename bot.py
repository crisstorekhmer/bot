    ...
    if updates and "result" in updates:
        for update in updates["result"]:
            ...
            if str(chat_id) == str(ADMIN_CHAT_ID) and "reply_to_message" in message:
                ...
                if target_chat_id:
                    # លុបសារទី១ (កំពុងផ្ទៀងផ្ទាត់) ចោលប្រសិនបើមានកត់ត្រាទុក
            ...
            # ២. ករណីអតិថិជនផ្ញើសារអត្ថបទធម្មតា ឬចុចប៊ូតុង
                ...
                if text in ["/start", "🚀 Start Bot"]:
                    ...
                    hok_menu = {
                        "keyboard": [
                            [{"text": "💎 80 Tokens - $1.10"}, {"text": "💎 240 Tokens - $3.30"}],
                            [{"text": "💎 420 Tokens - $5.50"}],
                            [{"text": "🔙 ត្រឡប់ក្រោយ"}],
                        ],
                        "resize_keyboard": True,
                    }
                    send_message(chat_id, "👑 *Honor of Kings* - សូមជ្រើសរើសកញ្ចប់ Tokens ខាងក្រោម៖", reply_markup=hok_menu)
                ...
                # កញ្ចប់ Honor of Kings
                elif text in [
                    "💎 80 Tokens - $1.10", "💎 240 Tokens - $3.30", "💎 420 Tokens - $5.50"
                ]:
